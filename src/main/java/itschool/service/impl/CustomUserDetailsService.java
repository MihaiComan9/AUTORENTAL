...
//clasa necesara pentru spring security
//extinde interfata UserDetailsService, care nu are implementare
//trebuie sa oferim noi implementarea
@Service
public class CustomUserDetailsService implements UserDetailsService {
    ...
    @Override
    @Transactional
    //de loaduserbyusername are nevoie spring security, cu rolurile sale s.a.m.d.
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        MyUser user = userService.findUserByUserName(userName);

        //getuserauthorities: pentru fiecare rol
    ...
    //tot pentru spring, cu asta ne logam
